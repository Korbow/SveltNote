    ...
    <>
        <div className="Hero">
              ...
              <div className="PinSection" ref={sectionRef}>
                <div className="HeroMiddleImg" id="StartGsapText" >
                  <div className="HeroImg" style={{ position: "relative", display: "inline-block" }}>
                      <img ref={imgRef} src="assets/img/carnet_real_nobg_o.png" alt="indisponibilité de trouver l'image" style={{ width: "100%", display: "block" }}></img>
            ...
            <section className="HeroEnd">
                ...
                <button className="button" onClick={() => window.open("./shop.html", "_blank")}>
